...
([[github](https://github.com/POORY-AZARE/php.teamwork/blob/main/index.php](https://github.com/POORY-AZARE/php.teamwork/blob/main/ReadData.php))) & link to the feature ([shell.hamk.fi](http://shell.hamk.fi/~poorya23000/php.teamwork/index.php)) .
